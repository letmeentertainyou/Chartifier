...
var diatonic_notes = { 'C#': 'Db', 'F#': 'Gb', 'B': 'Cb', 'Db': 'C#', 'Gb': 'F#', 'Cb': 'B' };
...
var primary_flats    = ['C', 'Db', 'D', 'Eb', 'E',  'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'B' ];
var secondary_flats  = ['C', 'Db', 'D', 'Eb', 'E',  'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'Cb'];
var tertiary_flats   = ['C', 'Db', 'D', 'Eb', 'Fb', 'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'Cb'];
...
var ionian_keys   = ['C', 'C#', 'Db', 'D', 'Eb', 'E', 'F', 'F#', 'Gb', 'G', 'Ab', 'A', 'Bb', 'B', 'Cb'];
var melodic_keys  = ['C', 'C#', 'Db', 'D', 'Eb', 'E', 'F', 'F#',            'Ab', 'A', 'Bb', 'B'      ];
var harmonic_keys = ['C', 'C#',            'Eb', 'E', 'F', 'F#',            'Ab', 'A', 'Bb', 'B'      ];
